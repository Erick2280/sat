/**
* Erick de Almeida Oliveira Riso e Heitor Silva dos Santos, 18 de novembro de 2018
...
* Descomentar as linhas console.log para passo-a-passo
* 
*/
...
function doSolve(clauses, assignment) {
  ...
  let currentAssignmentCounter = 1
  
  while ((!isSat) && !(currentAssignmentCounter == maximumAssignments)) {
    // Verifica se a tentativa atual satisfaz a fórmula
    
    let allClausesTrue = true
    
    // console.log("Analisando a tentativa " + currentAssignmentCounter + " de " + maximumAssignments + "...")
    ...
    for (let clause = 0; clause < clauses.length && allClausesTrue; clause++) {
      ...
      if (!thisClauseTrue) {
        ...
        // console.log("A cláusula " + (clause + 1) + " da tentativa " + currentAssignmentCounter + " é falsa.")
      }
    }
